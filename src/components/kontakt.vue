...
<div class="pt-72 max-[580px]:pt-32">
    <div class="w-full bg-black relative">
      <img src="/kontakt-photo.webp" alt="" class="h-[770px] w-full object-cover opacity-[0.3]">
        ...
        <li class="text-[16px] font-bold leading-[1.6] tracking-[0.2em]">TEL.BROJ:</li>
        ...
        <p class="text-[20px] pb-2 mx-4 tracking-[0.2em]">KONTAKTIRAJTE NAS:</p>
        <input type="text" required v-model="ime" name="ime" class="border-b leading-[0.15em] py-[15px] bg-[transparent] w-[600px] max-[900px]:w-[90%] pr-4" placeholder="Ime *">
        <input type="email" required v-model="email" name="email" class="bg-[transparent] border-b leading-[0.15em] py-[15px] w-[600px] max-[900px]:w-[90%] pr-4" placeholder="Email *">
        <input type="phone" required v-model="telefon" name="telefon" class="bg-[transparent] border-b leading-[0.15em] py-[15px] w-[600px] max-[900px]:w-[90%] pr-4" placeholder="Telefone *">
        <textarea id="" v-model="poruka" name="poruka" placeholder="Vaše pitanje" class="bg-[transparent] border-b leading-[0.15em] py-[15px] pt-[30px] w-[600px]  pr-4 max-h-[150px] min-h-[150px] max-[900px]:w-[90%]"></textarea>
